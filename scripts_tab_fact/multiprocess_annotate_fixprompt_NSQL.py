...
def main():
    ...
    # save unfiltered
    with open(os.path.join(args.save_dir, f'unfiltered_{args.dataset}_generation60_small_test_w_simple.json'),
              'w') as f:
    ...
    if args.use_filter:
        ...
        # save filtered
        with open(os.path.join(args.save_dir, f'filtered_{args.dataset}_generation60_small_test_w_simple.json'),
                  'w') as f:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--num_sort_by_prob', type=int, default=60)
    ...
    parser.add_argument('--sampling_n', type=int, default=60)
