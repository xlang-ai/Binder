...
def main():
    ...
    # save unfiltered
    with open(os.path.join(args.save_dir, f'unfiltered_{args.dataset}_nsqls_mmqa_v2_standard_Qa.json'), 'w') as f:
    ...
    if args.use_filter:
        ...
        # save filtered
        with open(os.path.join(args.save_dir, f'filtered_{args.dataset}_nsqls_mmqa_v2_standard_Qa.json'), 'w') as f:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--prompt_file', type=str, default='prompt_mmqa_v2_Qa.txt')
