...
def main():
    ...
    # save unfiltered
    with open(os.path.join(args.save_dir, f'unfiltered_{args.dataset}_qa.json'), 'w') as f:
    ...
    if args.use_filter:
        ...
        # save filtered
        with open(os.path.join(args.save_dir, f'filtered_{args.dataset}_qa.json'), 'w') as f:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--save_dir', type=str, default='../results_internal_knowledge/')
    parser.add_argument('--prompt_file', type=str, default='prompt_qa_balanced_no_table_input.txt')
    ...
    parser.add_argument('--prompt_style', type=str, default='no_table',
                        choices=['no_table',
                                 ...
                                 'create_table'])
    parser.add_argument('--num_shots', type=int, default=9)
